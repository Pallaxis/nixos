{
  flake.modules.homeManager.screenshot-tool = {pkgs, ...}: let
    screenshot-tool = pkgs.writeShellApplication {
      ...
      text = ''
        ...
        case "$1" in
          ...
          freeze-area-save)
            ...
            grimblast --freeze copysave area "$HOME/media/screenshots/screenshot-$(date +%F_%H-%M-%S).png"
            ;;
