...
while true do
  -- Puts SoM into janus mode for every boot
  -- while true do
  --   tio.msleep("50")
  --   tio.write("t")
  --   if tio.readline():find("5. Continue booting") then
  --     tio.write("\n")
  --     while not tio.readline():find("5. Cancel") do
  --       tio.msleep("50")
  --       tio.write("3\n")
  --     end
  --     tio.write("\n")
  ...
  --     end
  --     tio.write("\n")
  --     while not tio.readline():find("5. Continue booting") do
  --       tio.msleep("50")
  --       tio.write("5\n")
  --     end
  --     break
  ...
  -- tio.write(
  --   "hydra_provision -i 0 -s 0x0101 0x0602 -s 0x0401 0x0780 -s 0x0402 0x0438 -s 0x0403 0x003c -s 0x0103 0x0101\n"
  -- )

  tio.write(
    "hydra_provision -i 0 -s 0x0101 0x0602 -s 0x0401 0x0780 -s 0x0402 0x0438 -s 0x0403 0x003c -s 0x0103 0x0101 -a lt6911\n"
  )
  ...
  tio.write("set cap resolution 1920x1080\n")
  -- tio.expect(">>>")
  ...
  local command = "sh -c 'setsid ffplay -fflags nobuffer -flags low_delay -probesize 32 -analyzeduration 1 -autoexit rtsp://"
    .. ip
    .. ":8554/test >/dev/null 2>&1 & echo $!'"
  print(command)
